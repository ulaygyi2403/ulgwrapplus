...
window_title   = f"WARP-PLUS-CLOUDFLARE By U Lay Gyi (version {script_version})"
...
'     | |    | |  | |     _ _  | |     | | |\n'
'     | |_ _ | |  | |_____| |  | (_____) | |\n'
'     |_ _ _ _ |  |_ _ _ _ _|  (_________|_|\n')
print ("[+] ABOUT SCRIPT:")
print ("[-] With this script, you can getting unlimited GB on Warp+.")
print (f"[-] Version: {script_version}")
print ("--------")
print ("[+] THIS SCRIPT CODDED BY U Lay Gyi") 
print ("[-] SITE: satekyte.com") 
print ("[-] TELEGRAM: xnxx")
print ("--------")
...
while True:
	os.system('cls' if os.name == 'nt' else 'clear')
	print("")
	print("                  WARP-PLUS-CLOUDFLARE (script)" + " By U Lay Gyi")
	print("")
